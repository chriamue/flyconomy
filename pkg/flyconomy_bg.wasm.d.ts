...
export function wasm_bindgen__convert__closures__invoke1_mut__h0bad12c81fd2fc16(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hade83b835859849a(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h710863c363d981a4(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h1a64ef9c4a168c55(a: number, b: number, c: number): void;
