...
export function start_from_replay_string(a: number, b: number): void;
...
export function wasm_bindgen__convert__closures__invoke0_mut__hc50104992ee650bb(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h88ca5c6cbfe090e9(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h4363a79758bf5f9a(a: number, b: number, c: number, d: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__h111d9f2979ac6710(a: number, b: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h12095dc217e15dda(a: number, b: number, c: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__hf82c40e94a5a2df3(a: number, b: number, c: number): void;
