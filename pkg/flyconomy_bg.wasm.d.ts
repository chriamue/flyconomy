...
export function wasm_bindgen__convert__closures__invoke1_mut__h37daeccdf43bed6a(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke0_mut__hd6b926d8e0a66b33(a: number, b: number): void;
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h749bd5c4af6c0614(a: number, b: number, c: number): void;
